        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-md leading-relaxed">
              Full Stack Developer crafting high-quality web solutions that merge
              performance, scalability, and beautiful design. Passionate about clean
              code, elegant architectures, and problem solving.
            </p>
          </div>
